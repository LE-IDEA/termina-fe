...
const page = () => {
    ...
    return (
        <div className="flex flex-col gap-3 w-[364px] h-[191px] rounded-[24px] ">
            <div className="w-[364px] h-[136px]  rounded-[12px]">
                <div className="flex flex-row gap-3 w-[364px] h-[104px] p-3 border-[1px] border-solid border-black rounded-[12px]">
                    <div className="flex flex-col gap-1.5 w-[308px] h-[80px]">
                        ...
                        <div className="w-[308px] border-[0.4px] border-solid border-gray-500 opacity-50 rounded-lg"></div>
            ...
            <button
                className={`flex gap-2 w-[364px] h-[43px] pt-3 pr-6 pb-3 pl-6 rounded-[12px] ${isInputActive ? 'bg-blue-500' : 'bg-gray-500'
                    }`}
            >
